import fake_weather, generators, daily, retrieve, effect_bundle
...
model_tasmax = retrieve.ddp_from_url(crime_violent_tasmax_url)
model_pr = retrieve.ddp_from_url(crime_violent_pr_url)
